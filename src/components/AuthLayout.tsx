...
import authImage from '../image/authentication_image.png';
            ...
            <div className="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-center overflow-hidden z-10 px-12">
                <div className="relative z-10 text-center flex flex-col items-center animate-fade-in">
                    ...
                    <img
                        src={authImage}
                        alt="SIMCCS Logo"
                        className="w-auto max-w-[420px] max-h-[380px] object-contain mb-10 drop-shadow-[0_0_50px_rgba(99,102,241,0.3)]"
                    />
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-4 sm:p-8 relative overflow-hidden z-10">
                ...
                <div className="lg:hidden text-center mb-10 animate-fade-in">
                    <img
                        src={authImage}
                        alt="SIMCCS Logo"
                        className="w-20 h-20 object-contain mb-6 drop-shadow-[0_0_30px_rgba(99,102,241,0.3)] transform -rotate-3 hover:rotate-0 transition-transform duration-500"
                    />
